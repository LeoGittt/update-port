  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="flex-1 space-y-4 flex flex-col items-center sm:items-start justify-center mt-2">
            <div>
              ...
              <div className="mt-3 space-y-6">
                <p className="text-emerald-400 text-xs font-mono tracking-wider bg-emerald-400/10 px-3 py-1 rounded-full inline-block">
                  Frontend Developer
                </p>
        ...
        {/* About */}
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10 mb-14">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Estudiante de Programación en la UTN, impulsado por la curiosidad
              y la pasión por el mundo web. Disfruto transformar ideas en
              experiencias digitales elegantes y escalables, combinando lógica,
              diseño y un toque de creatividad en cada línea de código.
            </p>
          </div>
        </div>
